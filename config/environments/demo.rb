Hitthespot::Application.configure do
  ...
  config.action_mailer.default_url_options = { :host => 'demo.hitthespot.com' }
  ...
  config.after_initialize do    
    ...
    ::GATEWAY = ActiveMerchant::Billing::UsaEpayAdvancedGateway.new(
      :login => ENV['USA_EPAY_LOGIN'],
      :password => ENV['USA_EPAY_PASSWORD'],
      :software_id => ENV['USA_EPAY_SOFTWARE_ID']
    )
  end

  config.middleware.use ExceptionNotifier,
    email_prefix: "[HTS-Demo] ",
